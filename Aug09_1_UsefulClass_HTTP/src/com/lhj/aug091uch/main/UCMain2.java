...
// 구글지도 가서 위경도값 찾기
// ex)학원 !3d37.5693582!4d126.9858652
// https://api.openweathermap.org/data/2.5/weather?lat=37.5693582&lon=126.9858652&appid=인증키&units=metric&lang=kr
// -> 학원 날씨
...
public class UCMain2 {
	public static void main(String[] args) {
		...
		try {
			// 서버 연결
			String s = "https://api.openweathermap.org/data/2.5/weather?lat=37.5693582&lon=126.9858652&appid=인증키입력&units=metric&lang=kr";
			...
			FileOutputStream fos = new FileOutputStream("내 컴퓨터 로컬 경로 입력 ex) C:\\asdf\\asdf\\asdf\\asdf.csv", true);
