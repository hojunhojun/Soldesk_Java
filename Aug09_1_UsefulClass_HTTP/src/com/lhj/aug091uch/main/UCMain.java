...
public class UCMain {
	public static void main(String[] args) {
		...
		try {
			...
			huc.addRequestProperty("X-Naver-Client-Id", "인증키 ID 입력");
			huc.addRequestProperty("X-Naver-Client-Secret", "인증키 Secret 입력");
			
			InputStream is = huc.getInputStream();
			
			// 파일 열기 -> 프로세스의 실패 확률을 따져서 위치 조정
			FileOutputStream fos = new FileOutputStream("내 컴퓨터 주소 입력 ex) C:\\asdf\\asdf\\asdf\\asdf.txt", true);
