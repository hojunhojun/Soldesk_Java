...
public class UCMain3 {
	public static void main(String[] args) {
		...
		try {
			FileOutputStream fos = new FileOutputStream("내 컴퓨터 주소 입력 ex) C:\\asdf\\asdf\\asdf\\asdf.csv", true);
			OutputStreamWriter osw = new OutputStreamWriter(fos, "utf-8"); // 인코딩 방식 넣기
			bw = new BufferedWriter(osw);
			
			// URL u = new URL(s); 구버전
			URL u = URI.create("http://openapi.seoul.go.kr:8088/인증키/xml/RealtimeCityAir/1/25/").toURL();
