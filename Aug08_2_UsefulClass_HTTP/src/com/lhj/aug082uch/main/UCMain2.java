...
public class UCMain2 {
	public static void main(String[] args) {
		...
		try {
			// URL u = new URL(s); 구버전
			URL u = URI.create("https://www.kma.go.kr/wid/queryDFSRSS.jsp?zone=XXXX").toURL();
			// https://www.weather.go.kr/w/weather/forecast/short-term.do?nolayout=Y 여기에 검색해서 zone코드 찾기
