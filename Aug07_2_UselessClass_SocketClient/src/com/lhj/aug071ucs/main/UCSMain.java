...
//		포트번호 	: 어떤 서비스 이용하려고? (접속 목적 구별용도) : 1234은 소켓 접속용 포트번호임
//					1~65536
...
public class UCSMain {
	public static void main(String[] args) {
		...
		try {
			s = new Socket("#내아이피주소", 1234); // 이 주소는 내 컴퓨터(놑북)를 표현하는 주소
			// s = new Socket("127.0.0.1", 1234); // 이 주소는 내 컴퓨터(놑북)를 표현하는 주소
			// s = new Socket("localhost", 1234); // 이 주소는 내 컴퓨터(놑북)를 표현하는 주소
